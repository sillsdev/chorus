...
namespace Chorus.Properties {
	...
	internal class Resources {
		...
		internal static string ksInternetButtonLabel {
			get {
				return ResourceManager.GetString("ksInternetButtonLabel", resourceCulture);
			}
		}
		...
		/// <summary>
		///   Looks up a localized string similar to The computer does not have access to the specified network folder..
		/// </summary>
		internal static string ksSharedFolderInaccessible {
			get {
				return ResourceManager.GetString("ksSharedFolderInaccessible", resourceCulture);
			}
		}

		/// <summary>
		///   Looks up a localized string similar to This project is not yet associated with a shared folder..
		/// </summary>
		internal static string ksSharedFolderNotAssociated {
			get {
				return ResourceManager.GetString("ksSharedFolderNotAssociated", resourceCulture);
			}
		}
