...
namespace Chorus.Properties {
	...
	public class AnnotationImages {
		...
		/// <summary>
		///   Looks up a localized string similar to File or directory wasn&apos;t found.
		/// </summary>
		public static string kFileOrFolderNotFound {
			get {
				return ResourceManager.GetString("kFileOrFolderNotFound", resourceCulture);
			}
		}
