...
- Update libPalaso dependency from version 17.0.0-* to 18.0.0-*
- Update Newtonsoft.Json dependency from version 13.0.3 to 13.0.4
...
- Update L10NSharp dependency from version 9.0.0-* to 10.0.0-*
