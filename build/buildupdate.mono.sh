...
# build_type=ChorusPrecise64lfmergeCont
# root_dir=..
...
# *** Results ***
# build: chorus-precise64-lfmerge Continuous (ChorusPrecise64lfmergeCont)
# project: Chorus
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/NDesk.DBus.dll?branch=%3Cdefault%3E ../lib/ReleaseMono/NDesk.DBus.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/NDesk.DBus.dll.config?branch=%3Cdefault%3E ../lib/ReleaseMono/NDesk.DBus.dll.config
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/NDesk.DBus.dll?branch=%3Cdefault%3E ../lib/DebugMono/NDesk.DBus.dll
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/NDesk.DBus.dll.config?branch=%3Cdefault%3E ../lib/DebugMono/NDesk.DBus.dll.config
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/Palaso.dll.mdb?branch=%3Cdefault%3E ../lib/DebugMono/Palaso.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/Palaso.TestUtilities.dll.mdb?branch=%3Cdefault%3E ../lib/DebugMono/Palaso.TestUtilities.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/PalasoUIWindowsForms.dll.mdb?branch=%3Cdefault%3E ../lib/DebugMono/PalasoUIWindowsForms.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/PalasoUIWindowsForms.GeckoBrowserAdapter.dll.mdb?branch=%3Cdefault%3E ../lib/DebugMono/PalasoUIWindowsForms.GeckoBrowserAdapter.dll.mdb
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoPrecise64lfmergeContinuous/latest.lastSuccessful/debug/Palaso.Lift.dll.mdb?branch=%3Cdefault%3E ../lib/DebugMono/Palaso.Lift.dll.mdb
